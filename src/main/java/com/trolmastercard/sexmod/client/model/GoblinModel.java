...
public class GoblinModel extends ModelBase {
   ...
   public GoblinModel() {
      ...
      this.setRotation(var1, 1.0908F, 0.0F, 0.0F);
      ...
      this.setRotation(var2, 0.6109F, 0.0F, 0.0F);
      ...
      this.setRotation(var3, 0.3491F, 0.0F, 0.0F);
      ...
      this.setRotation(var4, 0.1309F, 0.0F, 0.0F);
