...
public class GalathPlayerEntity extends AbstractPlayerGirlEntity implements IGalath {
   ...
   public void b(String var1, UUID var2) {
      if ("cowgirl".equals(var1)) {
         ...
         this.a(this.ah_clash493(), fp.RAPE_INTRO);
      } else if ("mating press".equals(var1)) {
         this.b_clash577(var2);
         this.b(fp.CORRUPT_SLOW);
         this.a(this.ah_clash493(), fp.CORRUPT_SLOW);
         this.a_clash442();
      }
   }
   ...
   void a_clash442() {
      ...
      if (var1 != null) {
         Vec3d var2 = ck.a_clash306(new Vec3d(0.5, 0.5F - var1.func_70047_e(), 0.4F), this.I_clash415()).func_178787_e(this.o_clash501());
   ...
   public boolean c_clash21() {
      return this.ah_clash493() == 0 || this.ap;
   }
   ...
   void d_clash443() {
      if (this.n_clash537()) {
         if (this.y_clash492() == fp.RAPE_INTRO) {
            ...
            var1x -> {
               switch (var1x.sound) {
                  ...
                  case "setNude":
                     ...
                     Vec3d var5 = this.b_clash547("slipR").func_178787_e(var4);
                     Vec3d var6 = this.b_clash547("slipL").func_178787_e(var4);
                     Vec3d var7 = this.b_clash547("turnable").func_178787_e(var4);
                     this.field_70170_p
                  ...
                  case "setCamCorrupt":
                     ...
                     float var12 = this.I_clash415() + 220.0F;
                     Vec3d var13 = ck.a_clash306(new Vec3d(0.5, 0.5F - var11.func_70047_e(), 0.4F), this.I_clash415()).func_178787_e(this.o_clash501());
                     ...
                     if (this.n_clash537()) {
                        ...
                        if (var16.field_189982_i != 0.0F || var16.field_189983_j != 0.0F) {
                           Vec3d var17 = ck.a(
                              ...
                              RotationHelper.a_clash25(var14.field_70127_C, var14.field_70125_A, var10.func_184121_ak()),
                              RotationHelper.a_clash25(var14.field_70758_at, var14.field_70759_as, var10.func_184121_ak())
                           );
                           PacketHandler.b.sendToServer(new UpdateVelocityPacket(var17, this.f_clash491()));
                        }
                     }
                     break;
                  case "clap":
