...
public class AllieEntity extends BaseGirlEntity {
   ...
   public void func_70071_h_() {
      ...
      if (this.U != 1.0F && this.U != -69.0F && this.U <= 0.0F) {
         if (this.n_clash537()) {
            PacketHandler.b.sendToServer(new UploadInventoryToServerPacket2(this.f_clash491()));
            d3.a_clash122(true);
         }
   ...
   void b_clash698() {
      if (this.field_70173_aa % 10 == 0) {
         ...
         Vec3d var2 = this.b_clash547("tail" + var1).func_178787_e(this.func_174791_d());
         this.field_70170_p
            .func_175688_a(
   ...
   @SideOnly(Side.CLIENT)
   void c_clash700() {
      this.b_clash230(Minecraft.func_71410_x().field_71439_g);
      this.P = false;
   }
   ...
   public void b(fp var1) {
      if (this.y_clash492() != fp.DEEPTHROAT_CUM || var1 != fp.DEEPTHROAT_FAST && var1 != fp.DEEPTHROAT_SLOW) {
         if (this.y_clash492() != fp.REVERSE_COWGIRL_CUM
   ...
   public void registerControllers(AnimationData var1) {
      ...
      AnimationController.ISoundListener var2 = var1x -> {
         switch (var1x.sound) {
            case "summonMSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon1", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_SCAWY[0], 0.5F);
               break;
            case "summonMSG2":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon2", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_GIGGLE[this.func_70681_au().nextInt(4)]);
               break;
            case "summonMSG3":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon3", new Object[0]));
               break;
            case "summonMSG4":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon4", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_LIGHTBREATHING[2]);
               break;
            case "summonMSG5":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon5", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_HMPH[4]);
               break;
            case "summonMSG6":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon6", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_GIGGLE[3]);
               break;
            case "summonMSG7":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon7", new Object[0]));
               break;
            case "summonMSG8":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.summon8", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_HUH);
               if (this.n_clash537()) {
                  this.b_clash230(this.field_70170_p.func_152378_a(this.ae_clash498()));
               }
               break;
            case "summonDone":
            ...
            case "deepthroat_prepareMSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.hihi", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_GIGGLE);
               break;
            case "deepthroat_prepareMSG2":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.boys", new Object[0]));
            ...
            case "deepthroat_prepareDone":
               if (this.n_clash537()) {
                  if ("reverse_cowgirl".equals(this.m.func_187225_a(h))) {
                     ...
                     PacketHandler.b.sendToServer(new KoboldStatePacket(this.f_clash491(), this.ae_clash498(), false, true));
                     this.r = this.field_70177_z + 180.0F;
                     this.a_clash536(0.0, 0.0, 1.35F, 0.0F, 30.0F);
            ...
            case "deepthroat_fastMSG1":
               this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_BJMOAN));
               if (this.n_clash537()) {
            ...
            case "deepthroat_cumMSG1":
               this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_MOAN));
               this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_LIPSOUND));
               this.a(SoundHandler.a_clash804(SoundHandler.MISC_CUMINFLATION), 1.5F);
               break;
            ...
            case "summon_normalMSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.sup", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_GIGGLE[this.func_70681_au().nextInt(4)]);
               break;
            case "summon_normalMSG2":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.youhave", new Object[0]));
               break;
            case "summon_normalMSG3":
               if (((ItemStack)this.m.func_187225_a(N)).func_77978_p().func_74762_e("sexmodUses") == 2) {
                  this.a_clash541(I18n.func_135052_a("allie.dialogue.2wishes", new Object[0]));
               } else {
                  this.a_clash541(I18n.func_135052_a("allie.dialogue.1wish", new Object[0]));
               }
            ...
            case "summon_normalMSG5":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.tellme", new Object[0]));
               this.a(SoundHandler.GIRLS_ALLIE_HUH);
               break;
            ...
            case "deepthroat_normal_prepareMSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.alright", new Object[0]));
               this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_GIGGLE));
               break;
            case "rich_MSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.wishgranted", new Object[0]));
               this.a(SoundHandler.a_clash804(SoundHandler.MISC_PLOB));
               if (this.n_clash537()) {
            ...
            case "summon_sandMSG1":
               this.a_clash541(I18n.func_135052_a("allie.dialogue.nooo", new Object[0]));
            ...
            case "moan":
               ...
               break;
            case "mmm":
               this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_MMM));
               break;
            case "slide":
            ...
            case "slowMoan":
               if (this.func_70681_au().nextBoolean()) {
                  this.a(SoundHandler.a_clash804(SoundHandler.GIRLS_ALLIE_AHH));
               }
   ...
   public void a(String var1, UUID var2) {
      ...
      if ("action.names.makemerichallie".equals(var1)) {
         ...
         this.a_clash490("animationFollowUp", "action.names.deepthroat".equals(var1) ? "deepthroat" : "reverse_cowgirl");
