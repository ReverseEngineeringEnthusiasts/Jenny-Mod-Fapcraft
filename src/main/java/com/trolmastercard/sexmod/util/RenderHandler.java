...
public class RenderHandler {
   public static void register() {
      ...
      RenderingRegistry.registerEntityRenderingHandler(SlimeEntity.class, var0 -> new SlimeRenderer(var0, new SlimeNpcModel(), -0.2));
      RenderingRegistry.registerEntityRenderingHandler(BiaEntity.class, var0 -> new BiaRenderer(var0, new BiaNpcModel(), -0.4));
      RenderingRegistry.registerEntityRenderingHandler(AllieEntity.class, var0 -> new AllieRenderer(var0, new AllieNpcModel(), -0.4));
      ...
      RenderingRegistry.registerEntityRenderingHandler(LunaEntity.class, var0 -> new LunaRenderer(var0, new CatNpcModel(), -0.4));
      ...
      RenderingRegistry.registerEntityRenderingHandler(BiaPlayerEntity.class, var0 -> new PlayerBiaRenderer(var0, new BiaNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(JennyPlayerEntity.class, var0 -> new PlayerJennyRenderer(var0, new JennyNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(ElliePlayerEntity.class, var0 -> new PlayerEllieRenderer(var0, new EllieNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(SlimePlayerEntity.class, var0 -> new PlayerSlimeRenderer(var0, new SlimeNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(AlliePlayerEntity.class, var0 -> new PlayerAllieRenderer(var0, new AllieNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(BeePlayerEntity.class, var0 -> new PlayerBeeRenderer(var0, new BeeNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(LunaPlayerEntity.class, var0 -> new PlayerLunaRenderer(var0, new CatNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(KoboldPlayerEntity.class, var0 -> new PlayerKoboldRenderer(var0, new KoboldNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(GoblinPlayerEntity.class, var0 -> new PlayerGoblinRenderer(var0, new GoblinNpcModel()));
      RenderingRegistry.registerEntityRenderingHandler(GalathPlayerEntity.class, var0 -> new PlayerGalathRenderer(var0, new GalathNpcModel()));
