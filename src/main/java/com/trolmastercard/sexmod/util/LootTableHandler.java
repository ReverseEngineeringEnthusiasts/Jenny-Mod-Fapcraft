...
public class LootTableHandler {
   ...
   public static final ResourceLocation SLIME_TABLE = LootTableList.register(new ResourceLocation("sexmod", "slime"));
   public static final ResourceLocation BIA_TABLE = LootTableList.register(new ResourceLocation("sexmod", "bia"));
}
